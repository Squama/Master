...
public class FixedAssetsOfficeApplyListener implements TaskListener {

    private static final long serialVersionUID = 1301994420767445275L;
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        if (EVENTNAME_COMPLETE.equals(eventName)) {
            ...
            if (FALSE.equalsIgnoreCase(delegateTask.getVariable("approved").toString())) {
                ...
                if ("zongjingli".equals(delegateTask.getTaskDefinitionKey())) {
