...
import com.radish.master.entity.qualityCheck.Gcqzd;
import com.radish.master.entity.review.MaxNumber;
import com.radish.master.service.BudgetService;

@Controller
@RequestMapping("/gcqzd")
public class GcqzdController {
	private String prefix="QualityChecks/gcqzd/";
	...
	public String add(HttpServletRequest request){
		...
		if(id==null){
			String str =maxNum();
			request.setAttribute("bh","QZD"+str);
		}
	...
	@RequestMapping("/save")
	@ResponseBody
	public Result save(HttpServletRequest request,Gcqzd ps){
		String id = request.getParameter("id");
		Result r = new Result();
		User u = SecurityUtil.getUser();
		if(StringHelper.isNotEmpty(id)){//修改
			Gcqzd p = baseService.get(Gcqzd.class,id);
			...
			p.setJsdw(ps.getJsdw());
			p.setQzyy(ps.getQzyy());
			p.setSgbw(ps.getSgbw());
			p.setSgdw(ps.getSgdw());
	...
	public Result delete(HttpServletRequest request){
		String id = request.getParameter("id");
		Gcqzd sp = baseService.get(Gcqzd.class,id);
