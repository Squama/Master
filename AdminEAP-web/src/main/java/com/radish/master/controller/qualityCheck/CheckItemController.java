...
public class CheckItemController {
	...
	private static final String uploaderPath=PropertiesUtil.getValue("qualityChecksFilePath")+"\\checkRecord";
    ...
    public String list() {
        ...
        return "QualityChecks/checkRecord/check_tree";
    }
    @RequestMapping(method = RequestMethod.GET, value = "/list")
    public String listIndex(HttpServletRequest request) {
    	request.setAttribute("projectOptions", JSONArray.toJSONString(budgetService.getProjectCombobox()));
        return "QualityChecks/checkRecord/addIndex";
    }
    ...
    public String addWj(HttpServletRequest request) {
        ...
        return "QualityChecks/checkRecord/edit";
    }
    ...
    @ResponseBody
    public Result saveWj(HttpServletRequest request,CheckRecord cr){
    	Result r = new Result();
    	String fid = request.getParameter("fid");
    	...
    	if(cr.getId()==null){
    		...
    		CheckRecord c = baseService.get(CheckRecord.class, cr.getId());
    ...
    public Result deleteWj(String id,HttpServletRequest request) {
    	...
    	CheckRecord cr = baseService.get(CheckRecord.class, id);
	...
	public String fileIndex(HttpServletRequest request){
		...
		return "QualityChecks/checkRecord/fileIndex";
	}
