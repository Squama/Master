...
import com.radish.master.entity.qualityCheck.VideoFile;
import com.radish.master.service.BudgetService;

@Controller
@RequestMapping("/videofile")
public class VideoFileController {
	private String prefix="QualityChecks/videoFile/";
	...
	@RequestMapping("/save")
	@ResponseBody
	public Result save(HttpServletRequest request,VideoFile hj){
	...
	public Result deleteWj(String id,HttpServletRequest request) {
    	...
    	VideoFile cr = baseService.get(VideoFile.class, id);
	...
	private static final String uploaderPath=PropertiesUtil.getValue("qualityChecksFilePath")+"\\videofile";
