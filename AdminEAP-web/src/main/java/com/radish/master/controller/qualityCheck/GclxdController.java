...
@Controller
@RequestMapping("/gclxd")
public class GclxdController {
	private String prefix="QualityChecks/gclxd/";
	...
	public String add(HttpServletRequest request){
		...
		if(id==null){
			String str =maxNum();
			request.setAttribute("bh","LXD"+str);
		}
	...
	@RequestMapping("/save")
	@ResponseBody
	public Result save(HttpServletRequest request,Gclxd ps){
		String id = request.getParameter("id");
		Result r = new Result();
		User u = SecurityUtil.getUser();
		if(StringHelper.isNotEmpty(id)){//修改
			Gclxd p = baseService.get(Gclxd.class,id);
	...
	public Result delete(HttpServletRequest request){
		String id = request.getParameter("id");
		Gclxd sp = baseService.get(Gclxd.class,id);
