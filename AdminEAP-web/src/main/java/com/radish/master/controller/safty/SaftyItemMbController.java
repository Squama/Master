 ...
 */
@Controller
@RequestMapping("/checkRecordMbAQ")
public class SaftyItemMbController {
	...
	private static final String uploaderPath=PropertiesUtil.getValue("safetyManageFilePath")+"\\checkRecordMb";
    ...
    public String list() {
        ...
        return "safetyManage/checkRecordMb/check_tree";
    }
    @RequestMapping(method = RequestMethod.GET, value = "/list")
    public String listIndex(HttpServletRequest request) {
    	String lx = request.getParameter("lx");
		request.setAttribute("lx",lx);
        return "safetyManage/checkRecordMb/addIndex";
    }
    ...
    public String addWj(HttpServletRequest request) {
        ...
        return "safetyManage/checkRecordMb/edit";
    }
    ...
    public String scWj(HttpServletRequest request) {
        ...
        return "safetyManage/checkRecordMb/query_file";
    }
    
    @RequestMapping("saveWj")
    @ResponseBody
    public Result saveWj(HttpServletRequest request,CheckRecordMbAQ cr){
    	Result r = new Result();
    	String fid = request.getParameter("fid");
    	...
    	if(cr.getId()==null){
    		...
    		CheckRecordMbAQ c = baseService.get(CheckRecordMbAQ.class, cr.getId());
    ...
    public Result save(CheckItemAQ org) {
        ...
        saftyItemService.deleteCacheByKey(RedisConstant.CHECK_PRE + "tree");
    ...
    public Result deleteWj(String id,HttpServletRequest request) {
    	...
    	CheckRecordMbAQ cr = baseService.get(CheckRecordMbAQ.class, id);
	...
	public String fileIndex(HttpServletRequest request){
		...
		return "safetyManage/checkRecordMb/fileIndex";
	}
