...
*/
@Controller
@RequestMapping("/deptent")
public class DeptEntController {
    ...
    private String list() {
        ...
        return "workmanage/deptEnt/tree";
    }
    ...
    public List<Dict> getAll() {
    	String hql = "from Dict where code='ENTS' order by levelCode asc";
        List<Dict> dicts = dictService.find(hql);
        hql = "from Dict where  parent_id = '" +dicts.get(0).getId()+ "' order by levelCode asc";
        dicts = dictService.find(hql);
        return dicts;
    }
    ...
    public List<TreeNode> getTreeData() {
        ...
        return dictService.getTreeDataByCode("ENTS");
    }
